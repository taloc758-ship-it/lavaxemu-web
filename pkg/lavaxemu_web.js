/* @ts-self-types="./lavaxemu_web.d.ts" */
...
export class WebEmu {
    ...
    clear_pointer() {
        wasm.webemu_clear_pointer(this.__wbg_ptr);
    }
    /**
    ...
    frame(buf) {
        try {
            ...
            var ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_export2);
            var len0 = WASM_VECTOR_LEN;
            wasm.webemu_frame(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(buf));
     ...
     */
    height() {
        const ret = wasm.webemu_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    import_file(path, data) {
        ...
        wasm.webemu_import_file(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
    ...
    constructor(program) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(program, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.webemu_new(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    poll_dirty_files() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.webemu_poll_dirty_files(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    reset() {
        wasm.webemu_reset(this.__wbg_ptr);
    }
    /**
     ...
     */
    set_keys(keys) {
        const ptr0 = passArray8ToWasm0(keys, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.webemu_set_keys(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     */
    set_pointer(x, y, pressed) {
        wasm.webemu_set_pointer(this.__wbg_ptr, x, y, pressed);
    }
    /**
     * @returns {number}
     */
    width() {
        const ret = wasm.webemu_width(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lavaxemu_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
